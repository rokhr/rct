    ...
    return (
      ...
      {(() => {
        return !this.props.isEditting ?
          ...
          <React.Fragment>
            <p>
              <input type="text" name="title" value={this.props.title} onChange={(e) => this.onChangeTitle(e)} />
            </p>
            <p>
              <textarea name="description" value={this.props.description} onChange={(e) => this.onChangeDescription(e)} />
            </p>
